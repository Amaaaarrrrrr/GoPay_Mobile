          ...
          <View style={styles.form}>
            <View>
              ...
              <View style={styles.inputRow}>
                ...
                <TextInput style={styles.input} placeholder="e.g. KDD 456B" placeholderTextColor={C.mutedFg} autoCapitalize="characters" value={tillNumber} onChangeText={t => setTillNumber(t.toUpperCase())} />
              </View>
            </View>
            ...
            >
              {loading
                ...
                : <><Ionicons name="card" size={18} color={C.primaryFg} /><Text style={styles.submitText}>  Pay Fare</Text></>
              }
            </Pressable>
